...
ONLY Return a JSON with {
 ...
 "Category_1_Eyelid_Position_and_Appearance": {
   ...
   "Confidence Score": "How confident are you in the analysis? Rate your confidence on a scale from 1 to 100. Please be conservative and honest, and allow for variation in confidence levels between categories."
 },
